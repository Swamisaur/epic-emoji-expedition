        ...
        options: [
            {
                ...
                consequence: {
                    ...
                    payload: { effects: [{ name: "Overcharged", description: "+20% Attack Speed for 2 minutes. ⚡️", type: 'buff', modifiers: { percent: { attackSpeed: 0.20 } } }], duration_ms: 120000 },
            ...
            },
            {
                ...
                consequence: {
                    type: EventConsequenceType.TELEPORT,
                    payload: { substages: -1 },
                    resultText: "It's too risky 😬. You spend a long time navigating a maze of scrap to get around it. 😩",
                    outcomeEmoji: '😩'
                }
            }
        ]
